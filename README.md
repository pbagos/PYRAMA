...
- [Usage](#usage)  
  - [GWAS Meta-Analysis](#gwas-meta-analysis)  
    - [Case: Direct BETA/SE (No Imputation)](#case-2-direct-betase-no-imputation)  
    - [Case: BETA/SE + Imputation](#case-2-betase--imputation)  
    - [Case: Discrete Phenotypes (Standard, Fast, Bayesian)](#case-1-discrete-phenotypes-standard-fast-bayesian)  
    - [Case: Continuous Phenotypes](#case-3-continuous-phenotypes)  
